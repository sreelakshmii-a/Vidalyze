...
from sentiment import analyze_sentiment_fallback, compute_stats, generate_insights_fallback
...
def history():
    """Returns the 20 most recent analyses from persistent storage."""
...
def analyze():
    ...
    save_analysis(video_id, result)   # persist summary to SQLite
